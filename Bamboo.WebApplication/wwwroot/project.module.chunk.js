...
var FileService = (function () {
    function FileService(http, settings) {
        this.http = http;
        this.settings = settings;
    }
    FileService.prototype.convertToFileModel = function (file) {
        var result = {
            name: file.name,
            value: ''
        };
    ...
    FileService.prototype.removeFile = function (id) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_file_service__ = __webpack_require__("../../../../../src/app/_services/file.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ProjectCreateComponent = (function () {
    function ProjectCreateComponent(projectService, router, messageService, fileService) {
        this.projectService = projectService;
        this.router = router;
        this.messageService = messageService;
        this.fileService = fileService;
        this.success = { severity: 'success', summary: 'Thêm Dự Án Thành Công', detail: 'Thành Công' };
        this.fail = { severity: 'error', summary: 'Thêm Dự Án Thất Bại', detail: 'Thất Bại' };
    ...
    ProjectCreateComponent.prototype.onUploadFile = function (files) {
    ...
    ProjectCreateComponent.prototype.addNewProject = function (event) {
        ...
        this.projectService.createProject(this.newProject).subscribe(function (data) {
            _this.messageService.add(_this.success);
            setTimeout(function () {
                _this.router.navigateByUrl("/du-an/danh-sach");
            }, 1000);
        }, function (error) {
            _this.messageService.add(_this.fail);
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_primeng_components_common_messageservice__ = __webpack_require__("../../../../primeng/components/common/messageservice.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_primeng_components_common_messageservice___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_primeng_components_common_messageservice__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_setting_service__ = __webpack_require__("../../../../../src/app/_services/setting.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_file_service__ = __webpack_require__("../../../../../src/app/_services/file.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ProjectEditComponent = (function () {
    function ProjectEditComponent(projectService, router, route, messageService, settingService, fileService) {
        var _this = this;
        this.projectService = projectService;
        this.router = router;
        this.route = route;
        ...
        this.fileService = fileService;
        this.baseUrl = this.settingService.admin;
        this.success = { severity: 'success', summary: 'Thêm Dự Án Thành Công', detail: 'Thành Công' };
        this.fail = { severity: 'error', summary: 'Xóa Dự Án Thất Bại', detail: 'Thất Bại' };
        this.editProject = {
            id: 0,
            title: '',
            investor: '',
    ...
    ProjectEditComponent.prototype.onUploadFile = function (files) {
    ...
    ProjectEditComponent.prototype.getProjectCategories = function () {
        var _this = this;
        this.projectService.getProjectCategories().subscribe(function (data) {
            _this.projectCategories = data;
        });
    ...
    ProjectEditComponent.prototype.getProject = function (id) {
        var _this = this;
        this.projectService.getProjectById(id).subscribe(function (data) {
            _this.editProject = data;
            console.log(_this.editProject);
        });
    };
    ...
    ProjectEditComponent.prototype.removeFile = function (id, index) {
        var _this = this;
        this.fileService.removeFile(id).subscribe(function (daata) {
            _this.messageService.add({ severity: 'success', summary: 'Xóa hình ảnh thành công', detail: 'Thành Công' });
            _this.editProject.fileModels.splice(index, 1);
        });
    };
    ProjectEditComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_project_service__["a" /* ProjectService */],
            ...
            __WEBPACK_IMPORTED_MODULE_4_primeng_components_common_messageservice__["MessageService"],
            __WEBPACK_IMPORTED_MODULE_5__services_setting_service__["a" /* SettingsService */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__services_file_service__ = __webpack_require__("../../../../../src/app/_services/file.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
        ...
        children: [
            {
                ...
                children: [
                    { path: 'danh-sach/tao-moi', component: __WEBPACK_IMPORTED_MODULE_7__project_create_project_create_component__["a" /* ProjectCreateComponent */] },
                    { path: 'danh-sach/:id', component: __WEBPACK_IMPORTED_MODULE_10__project_edit_project_edit_component__["a" /* ProjectEditComponent */] },
                    { path: 'danh-sach', component: __WEBPACK_IMPORTED_MODULE_9__project_list_project_list_component__["a" /* ProjectListComponent */] },
                ]
            }
        ]
    }
...
var ProjectModule = (function () {
    ...
    ProjectModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            providers: [
                __WEBPACK_IMPORTED_MODULE_11__services_project_service__["a" /* ProjectService */], __WEBPACK_IMPORTED_MODULE_12_primeng_components_common_messageservice__["MessageService"], __WEBPACK_IMPORTED_MODULE_8_primeng_primeng__["ConfirmationService"], __WEBPACK_IMPORTED_MODULE_13__services_file_service__["a" /* FileService */]
            ]
        })
    ], ProjectModule);
